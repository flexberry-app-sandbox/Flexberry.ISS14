...
namespace IIS.ISS14
{
    ...
    public class ВидПоддержки : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.ISS14.Пользователь fПользователь;
        ...
        [NotNull()]
        public virtual IIS.ISS14.Пользователь Пользователь
        {
            get
            {
                ...
                IIS.ISS14.Пользователь result = this.fПользователь;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ВидПоддержкиE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ВидПоддержкиE", typeof(IIS.ISS14.ВидПоддержки));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ВидПоддержкиL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ВидПоддержкиL", typeof(IIS.ISS14.ВидПоддержки));
                }
            }
        }
    }
